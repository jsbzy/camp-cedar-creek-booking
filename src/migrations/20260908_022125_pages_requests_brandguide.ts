...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_requests_status" AS ENUM('new', 'planned', 'building', 'done', 'declined');
  CREATE TYPE "public"."enum_requests_size" AS ENUM('unknown', 'small', 'big');
  CREATE TABLE "pages" (
  ...
  CREATE TABLE "requests" (
  	...
  	"detail" varchar,
  	"status" "enum_requests_status" DEFAULT 'new',
  	"size" "enum_requests_size" DEFAULT 'unknown',
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "brand_guide" DISABLE ROW LEVEL SECURITY;
  DROP TABLE "pages" CASCADE;
  DROP TABLE "_pages_v" CASCADE;
  DROP TABLE "requests" CASCADE;
  DROP TABLE "brand_guide" CASCADE;
  ALTER TABLE "payload_locked_documents_rels" DROP CONSTRAINT "payload_locked_documents_rels_pages_fk";
  
  ALTER TABLE "payload_locked_documents_rels" DROP CONSTRAINT "payload_locked_documents_rels_requests_fk";
  ...
  DROP TYPE "public"."enum_requests_size";`)
}
